...
namespace EduTrack.API.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        /// <returns></returns>
        [TDPermission("CreateAsync", "Tạo tài khoản")]
        [TDAuthorize]
        [Route("create")]
        [HttpPost]
        ...
        /// <param name="reqDto"></param>
        /// <returns></returns>
        [TDPermission("UpdateAsync", "Cập nhật tài khoản")]
        [TDAuthorize]
        [Route("update")]
        [HttpPost]
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [TDPermission("DeleteAsync", "Xóa tài khoản")]
        [TDAuthorize]
        [Route("delete/{id}")]
        [HttpPost]
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [TDPermission("GetByIdAsync", "Xem chi tiết tài khoản")]
        [TDAuthorize]
        [Route("get-by-id/{id}")]
        [HttpGet]
        ...
        /// <returns></returns>
        [TDPermission("GetByFilterAsync", "Xem danh sách tài khoản")]
        [TDAuthorize]
        [Route("get-by-filter")]
        [HttpPost]
