...
export class RoleGridComponent extends TdBaseGridComponent implements OnInit {
  ...
  constructor(_toastService: ToastService, _roleService: RoleService) {
  ...
  onDeleteMany() {
    if (this.setOfCheckedId.size == 0) {
      this._toastService.warning(
        StatusResponseTitle.WARNING,
        StatusResponseMessage.NOT_SELECTED
      );
      return;
    }
